...
class CommitteesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create committee" do
    assert_difference('Committee.count') do
      post committees_url, params: { committee: { comitname: @committee.comitname, committeeID: @committee.committeeID, facultyID: @committee.facultyID, meetday: @committee.meetday } }
    end
  ...
  test "should update committee" do
    patch committee_url(@committee), params: { committee: { comitname: @committee.comitname, committeeID: @committee.committeeID, facultyID: @committee.facultyID, meetday: @committee.meetday } }
