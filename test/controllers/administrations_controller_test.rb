...
class AdministrationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create administration" do
    assert_difference('Administration.count') do
      post administrations_url, params: { administration: { adminID: @administration.adminID, extension: @administration.extension, firstname: @administration.firstname, lastname: @administration.lastname, title: @administration.title } }
    end
  ...
  test "should update administration" do
    patch administration_url(@administration), params: { administration: { adminID: @administration.adminID, extension: @administration.extension, firstname: @administration.firstname, lastname: @administration.lastname, title: @administration.title } }
