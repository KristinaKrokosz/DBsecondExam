...
ActiveRecord::Schema.define(version: 2018_12_03_003549) do

  create_table "administrations", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci", force: :cascade do |t|
    t.integer "adminID"
    t.string "firstname"
    t.string "lastname"
    t.string "title"
