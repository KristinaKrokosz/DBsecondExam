...
class FacultiesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create faculty" do
    assert_difference('Faculty.count') do
      post faculties_url, params: { faculty: { department: @faculty.department, email: @faculty.email, fName: @faculty.fName, facultyID: @faculty.facultyID, lName: @faculty.lName } }
    end
  ...
  test "should update faculty" do
    patch faculty_url(@faculty), params: { faculty: { department: @faculty.department, email: @faculty.email, fName: @faculty.fName, facultyID: @faculty.facultyID, lName: @faculty.lName } }
